                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        if (drive.DriveFormat == "NTFS" && (x == y || x < y * 1.01))
                        {
                            ...
                            ////////////////////////////////////////////////////////////////////////////////////////
                            Directory.CreateDirectory(d + "\\ATAK_Silme");
                            XmlTextWriter yaz = new XmlTextWriter(d + "\\ATAK_Silme\\silme.xml", System.Text.UTF8Encoding.UTF8);
                            yaz.Formatting = Formatting.Indented;

                            yaz.WriteStartDocument();
                            yaz.WriteStartElement("Ogretmen");
                            ...
                            File.SetAttributes(@d + "ATAK_Silme", FileAttributes.Hidden);
                        }
                        else
                        {
